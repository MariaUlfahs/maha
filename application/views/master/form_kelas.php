	...
	<div class="modal-body">
		<form class="form-horizontal" method="post" id="formdata">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="semester" placeholder="Isilah dengan angka" name="semester" value="<?php echo @$semester ?>" required>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">Angkatan</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" id="angkatan" placeholder="masukkan tahun masuk" name="angkatan" value="<?php echo @$angkatan ?>" required>
				</div>
			</div>
...
$(function(){
    $("#formdata").submit(function(event){
        ...
        $.ajax({
            url:'<?php echo base_url('master/simpan_kelas') ?>',
            cache: false,
            type:'POST',
            data:$(this).serialize(),
